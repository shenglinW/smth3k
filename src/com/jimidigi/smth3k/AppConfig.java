...
public class AppConfig{
	...
	public final static String TEMP_BOARD = "temp_board";
    ...
    public final static String CONF_ADS = "pref_ads";
	...
	public long getExpiresIn(){
		return StringUtility.toLong(get(CONF_EXPIRESIN));
	}
	...
	{
		if(accessInfo == null && !StringUtility.isEmpty(getAccessToken()) && !StringUtility.isEmpty(getAccessSecret()))
		{
			accessInfo = new AccessInfo();
