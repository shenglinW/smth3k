 ...
 * @created 2012-3-21
 */
public class MailForward extends BaseActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.mail_forward);
	...
	private View.OnClickListener publishClickListener = new View.OnClickListener() {
		public void onClick(View v) {	
			...
			if(StringUtility.isEmpty(_receiver)){
			...
			if(!ac.isLogin()){
				UIHelper.showLoginDialog(MailForward.this);
				return;
			}
			...
			final Handler handler = new Handler(){
				public void handleMessage(Message msg) {
					...
					if(msg.what == 1){
						...
						UIHelper.ToastMessage(MailForward.this, res.getErrorMessage());
						if(res.isOk()){
							//发送通知广播
								UIHelper.sendBroadCast(MailForward.this, res);
							finish();
						}
					}
					else {
						((AppException)msg.obj).makeToast(MailForward.this);
					}
				}
			};
			new Thread(){
